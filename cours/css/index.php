...
<meta property="og:url" content="https://cristlor-demo.000webhostapp.com/cours/css">
...
<body>
    ...
    <li><a href="https://cristlor-demo.000webhostapp.com/cours/css/" class="current">CSS</a></li>
    </ul>
    </div>
        <div class="alert info">  
  <strong><i class="fa fa-bell"></i></strong> Avant de commencer, il est conseillé d'apprendre le <a href="https://cristlor-demo.000webhostapp.com/cours/html/">HTML</a>.
</div>
        
        <button class="accordion"><i class="fa fa-list-alt"></i> Introduction</button>
<div class="acc-panel">
  <ol>
      <li><a href="https://cristlor-demo.000webhostapp.com/cours/css/learn/fonctionnement.php">Le fonctionnement</a></li>
      <li><a href="https://cristlor-demo.000webhostapp.com/cours/css/learn/editeur-de-texte.php">L'éditeur de texte</a></li>
  </ol>
</div>
...
<div class="acc-panel">
    <ol>
        <li><a href="https://cristlor-demo.000webhostapp.com/cours/css/learn/notre-premiere-page-avec-du-css.php">Notre première page avec du CSS</a></li>
        <li>...</li>
    </ol>
</div>
<br>
               <div style="text-align: center;">
               <button id="btn-version-pdf" style="width: 200px;" onclick="window.location.href='https://cristlor-demo.000webhostapp.com/pdf/files.pdf';"><i class="fa fa-file-pdf"></i> Voir la version PDF</button>
               </div>
...
<br>
           <div class="content-preview notranslate">
              ...
              <button style="width: 150px;" onclick="window.location.href='https://cristlor-demo.000webhostapp.com/cours/css/demos/test.html';">Aller voir la page</button>
           </div>
           </div>
       ...
       <br>
       <span class="link-url">
       <a role="button" href="#" onclick="copyToClipboard(this)"  class="fa fa-link" link="https://cristlor-demo.000webhostapp.com/cours/css/#link-copied"></a>
       </span>
       <br><br>
       <!-- AddToAny BEGIN -->
